...
The mean number of steps take per day is now `r meanperdaynona` and the median is `r medianperdaynona` steps per day.
...
The number of NA's in the dataset should therefore equal 8 days times 288 intervals per day, which is indeed `r numna` as reported above.  
